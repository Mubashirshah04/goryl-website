...
const generateOrderEmailHTML = (order, trackingNumber) => {
    ...
    <body>
        ...
        return `
                    <div class="item">
                        <p><strong>${((_a = item.product) === null || _a === void 0 ? void 0 : _a.title) || 'Product'}</strong></p>
                        <p>Quantity: ${item.quantity} × $${(((_b = item.product) === null || _b === void 0 ? void 0 : _b.price) || 0).toFixed(2)} = $${((((_c = item.product) === null || _c === void 0 ? void 0 : _c.price) || 0) * item.quantity).toFixed(2)}</p>
                    </div>
                `;
    }).join('')}
...
export const sendTrackingUpdateEmail = async (orderId, trackingNumber, status, userEmail) => {
    try {
