      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex items-center justify-center p-4">
        <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 max-w-md w-full text-center border border-white/20">
          ...
          <button
            ...
            className="bg-gradient-to-r from-purple-500 to-indigo-500 text-white px-6 py-3 rounded-xl font-bold hover:from-purple-600 hover:to-indigo-600 transition-all duration-300"
          >
            Go to Login
          </button>
        </div>
      ...
      <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 max-w-2xl w-full border border-white/20">
        ...
        <div className="bg-white/5 rounded-2xl p-6 mb-6 border border-white/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-white font-semibold">{userData?.role || 'Not set'}</p>
            </div>
            <div>
              <p className="text-purple-200 text-sm">Account Type</p>
              <p className="text-white font-semibold">{userData?.accountType || 'Not set'}</p>
            </div>
            <div>
              <p className="text-purple-200 text-sm">Verified Seller</p>
              <p className="text-white font-semibold">
                {userData?.isVerifiedSeller ? 'Yes' : 'No'}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button
            ...
            disabled={loading}
            className="flex-1 bg-gradient-to-r from-green-500 to-emerald-500 text-white px-6 py-4 rounded-xl font-bold hover:from-green-600 hover:to-emerald-600 transition-all duration-300 disabled:opacity-50 flex items-center justify-center"
          >
            {loading ? (
              <>
          ...
          <button
            ...
            className="px-6 py-4 bg-white/10 text-white rounded-xl font-bold hover:bg-white/20 transition-all duration-300 border border-white/20"
          >
            Go Home
          </button>
        </div>
