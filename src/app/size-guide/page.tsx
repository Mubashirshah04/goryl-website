...
import { Ruler, Shirt, Users, HelpCircle, Download, Printer } from 'lucide-react';
              ...
              <table className="w-full">
                ...
                <tbody>
                  {clothingSizes.map((size, index) => (
                    <tr key={size.size} className={`border-b border-gray-100 ${index % 2 === 0 ? 'bg-gray-50' : ''}`}>
              ...
              <table className="w-full">
                ...
                <tbody>
                  {shoeSizes.map((size, index) => (
                    <tr key={size.us} className={`border-b border-gray-100 ${index % 2 === 0 ? 'bg-gray-50' : ''}`}>
