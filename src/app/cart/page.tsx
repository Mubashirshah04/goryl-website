...
export default function CartPage() {
  ...
  useEffect(() => {
    if (user && !cart) {
      useCartStore.getState().initializeCart(user.userId);
    }
  }, [user, cart]);
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">Looks like you haven't added any items to your cart yet.</p>
            <Link
              href="/"
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    >
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-gray-600 dark:text-gray-300 text-sm">Rs {item.product.price}</p>
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-gray-500 dark:text-gray-400 text-sm">Rs {item.product.price} each</p>
                        </div>
                        ...
                        <button
                          ...
                          disabled={loading}
                          className="p-2 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-full disabled:opacity-50"
                        >
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden sticky top-8">
              <div className="p-6 border-b border-gray-200 dark:border-gray-700">
              ...
              <div className="p-6 space-y-4">
                ...
                <motion.button
                  ...
                  className="w-full bg-purple-600 text-white font-semibold py-4 px-6 rounded-xl hover:bg-purple-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                >
                ...
                <Link
                  href="/"
                  className="block w-full text-center text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white font-medium py-3"
                >
                  Continue Shopping
                </Link>
              </div>
