...
import { Dumbbell, Trophy, Bike, Users, Heart, Droplets, Zap, Mountain, Snowflake, Shield, Music, Flag, Target, ArrowLeft, Search, Grid3X3, List, Star, ShoppingCart, Eye } from 'lucide-react';
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 mb-8">
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input type="text" placeholder="Search sports & fitness..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="w-full pl-10 pr-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"/>
            </div>
