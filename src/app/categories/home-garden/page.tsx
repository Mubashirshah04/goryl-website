...
import { 
  Home, Sofa, Lamp, ChefHat, Package, Sparkles, PawPrint, Wrench, 
  Paintbrush, Shield, Wifi, Monitor, Baby, Droplets, Wind, 
  Thermometer, ArrowLeft, Search, Filter, Grid3X3, List, Star, 
  Heart, ShoppingCart, Eye, TrendingUp, Zap
} from 'lucide-react';
