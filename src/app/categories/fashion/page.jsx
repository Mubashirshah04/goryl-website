...
import { Shirt, Sparkles, Baby, ShoppingBag, Diamond, Dumbbell, Droplets, Heart, Gift, Clock, Globe, Users, ArrowLeft, Search, Grid3X3, List, Star, Heart as HeartIcon, ShoppingCart, Eye } from 'lucide-react';
    ...
    useEffect(() => {
        const loadProducts = async () => {
            try {
                ...
                // const firebaseProducts = await getProductsByCategory('fashion');
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="flex-1 relative">
              <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5"/>
                          <input type="text" placeholder="Search fashion..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="w-full pl-10 pr-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"/>
                    </div>
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-6 h-full transition-all duration-500 group-hover:bg-white/10 group-hover:border-purple-400/30 group-hover:shadow-2xl group-hover:shadow-purple-500/20 group-hover:scale-105">
                  <div className="relative mb-4">
                    <div className="w-full h-48 rounded-2xl overflow-hidden">
                      <img src={product.images[0]} alt={product.title} width="400" height="300" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"/>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-2">
                      <img src={product.seller.avatar} alt={product.seller.name} width="24" height="24" className="rounded-full"/>
