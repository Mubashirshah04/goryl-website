...
import { 
  ...
  Plus, Edit, Eye, Trash2, Upload, BarChart3, Settings,
  ArrowRight, Calendar, Star, MessageSquare, Heart, CreditCard,
  Building, Crown
} from 'lucide-react'
...
import { 
  getNormalUserStats,
  getNormalUserOrders,
  getPersonalSellerStats,
  getPersonalSellerProducts,
  getPersonalSellerOrders,
  getBrandStats,
  getCompanyStats,
  getUserWallet,
  ...
  UserProduct,
  WalletTransaction
} from '@/lib/userDashboardService'

export default function UserDashboardPage() {
  const [stats, setStats] = useState<UserDashboardStats | SellerDashboardStats | BrandDashboardStats | CompanyDashboardStats | null>(null)
  const [orders, setOrders] = useState<UserOrder[] | SellerOrder[]>([])
  const [products, setProducts] = useState<UserProduct[]>([])
  const [wallet, setWallet] = useState<any>(null)
  const [transactions, setTransactions] = useState<WalletTransaction[]>([])
  const [loading, setLoading] = useState(true)
  const [activeTab, setActiveTab] = useState<'overview' | 'orders' | 'products' | 'wallet' | 'analytics'>('overview')
  ...
  const getUserType = (user: any): 'normal' | 'personal' | 'brand' | 'company' => {
    if (user.role === 'admin') return 'normal'
    if (user.sellerType === 'personal') return 'personal'
    if (user.sellerType === 'brand') return 'brand'
    if (user.sellerType === 'company') return 'company'
    return 'normal'
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                  ...
                  <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-2xl font-semibold text-gray-900 dark:text-white">{(stats as UserDashboardStats).totalOrders}</p>
                        <p className="text-sm text-blue-600">+{(stats as UserDashboardStats).monthlyGrowth}% this month</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-2xl font-semibold text-gray-900 dark:text-white">{formatCurrency((stats as UserDashboardStats).totalSpent)}</p>
                  ...
                  <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-2xl font-semibold text-gray-900 dark:text-white">{(stats as UserDashboardStats).savedProducts}</p>
                  ...
                  <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-2xl font-semibold text-gray-900 dark:text-white">{(stats as UserDashboardStats).totalReviews}</p>
                ...
                <>
                  <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-2xl font-semibold text-gray-900 dark:text-white">{formatCurrency((stats as SellerDashboardStats).totalSales)}</p>
                        <p className="text-sm text-green-600">+{(stats as SellerDashboardStats).monthlyGrowth}% this month</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <p className="text-sm font-medium text-gray-500">Total Orders</p>
                        <p className="text-2xl font-semibold text-gray-900 dark:text-white">{(stats as SellerDashboardStats).totalOrders}</p>
                        <p className="text-sm text-blue-600">{(stats as SellerDashboardStats).pendingOrders} pending</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-2xl font-semibold text-gray-900 dark:text-white">{(stats as SellerDashboardStats).totalProducts}</p>
                  ...
                  <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-2xl font-semibold text-gray-900 dark:text-white">{(stats as SellerDashboardStats).totalCustomers}</p>
                ...
                <>
                  <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-2xl font-semibold text-gray-900 dark:text-white">{formatCurrency((stats as BrandDashboardStats).totalRevenue)}</p>
                        <p className="text-sm text-green-600">+{(stats as BrandDashboardStats).monthlyGrowth}% this month</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-2xl font-semibold text-gray-900 dark:text-white">{(stats as BrandDashboardStats).totalBrands}</p>
                        <p className="text-sm text-purple-600">{(stats as BrandDashboardStats).brandFollowers} followers</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-2xl font-semibold text-gray-900 dark:text-white">{(stats as BrandDashboardStats).averageRating.toFixed(1)}</p>
                  ...
                  <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <p className="text-sm font-medium text-gray-500">Products</p>
                        <p className="text-2xl font-semibold text-gray-900 dark:text-white">{(stats as BrandDashboardStats).totalProducts}</p>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {orders.slice(0, 5).map((order) => (
                      <tr key={order.id}>
                        ...
                        {getUserType(user) === 'normal' ? (
                          <>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">{(order as UserOrder).productName}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">{(order as UserOrder).sellerName}</td>
                          </>
                        ) : (
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">{(order as SellerOrder).buyerName}</td>
                        )}
        ...
        {activeTab === 'products' && getUserType(user) !== 'normal' && (
          <div className="bg-white rounded-lg shadow">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {products.map((product) => (
                    <tr key={product.id}>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <img className="h-10 w-10 rounded-lg object-cover" src={product.media[0]?.url || '/placeholder-product.jpg'} alt={product.title} />
                          <div className="ml-4">
