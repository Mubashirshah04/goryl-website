...
import { signInWithEmailAndPassword, signInWithPopup, GoogleAuthProvider, signOut } from '@/lib/firebaseAuth';
      ...
      <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8">
        ...
        <div className="mt-6">
          ...
          <button
            ...
            disabled={loading}
            className="mt-4 w-full bg-white hover:bg-gray-50 border border-gray-300 text-gray-700 dark:text-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 font-semibold py-3 rounded-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link href="/register" className="text-purple-600 hover:text-purple-500 dark:text-purple-400 font-semibold">
              Sign up
            </Link>
          </p>
        </div>
