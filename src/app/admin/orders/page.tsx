...
import {
  ShoppingCart, Eye, Truck, CheckCircle, X, Download, Filter,
  ChevronDown, ChevronUp, DollarSign, Calendar, MapPin, User, Package
} from 'lucide-react'
...
export default function AdminOrdersPage() {
  ...
  const handleOrderAction = async (orderId: string, action: string, details?: any) => {
    try {
  ...
  return (
    <AdminLayout
      ...
      subtitle="Manage platform orders and payment processing"
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div className="flex items-center space-x-2">
                          <button
                            ...
                            onClick={() => {/* Open order detail drawer */}}
                          >
