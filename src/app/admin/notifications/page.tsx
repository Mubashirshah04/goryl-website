...
import { 
  Bell, Send, Users, Building, Crown, UserCheck, Calendar, Clock,
  CheckCircle, XCircle, AlertTriangle, MessageSquare, Target, Filter,
  Download, Plus, Eye, Trash2, Edit, Copy, ExternalLink
} from 'lucide-react'
...
interface Notification {
  ...
  target: 'all' | 'normal' | 'personal' | 'brand' | 'company'
  sentAt: Date
  sentBy: string
...
export default function NotificationsPage() {
  ...
  const [selectedTarget, setSelectedTarget] = useState<'all' | 'normal' | 'personal' | 'brand' | 'company'>('all')
  ...
  return (
    <AdminLayout 
      title="Notifications" 
      subtitle="Send global notifications and manage notification history"
      actions={
        ...
        {showCreateModal && (
          ...
          >
            <motion.div
              ...
              className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl w-full max-w-2xl"
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                    {(['all', 'normal', 'personal', 'brand', 'company'] as const).map((target) => (
                      <button
                        key={target}
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white/10 border border-white/20 rounded-2xl p-4 text-white placeholder-purple-300 focus:outline-none focus:ring-2 focus:ring-purple-400"
                  />
                </div>
                ...
                <div className="flex items-center justify-end space-x-4">
                  ...
                  <motion.button
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-purple-500 to-fuchsia-500 text-white rounded-xl hover:from-purple-600 hover:to-fuchsia-600 transition-all duration-300 disabled:opacity-50 flex items-center space-x-2"
                  >
                    {loading ? (
                      <>
