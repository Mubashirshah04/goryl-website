...
import {
  Settings, Save, Plus, Trash2, Edit, Eye, Globe, ToggleLeft, ToggleRight,
  Tag, Folder, AlertCircle, CheckCircle, X, ChevronDown, ChevronUp
} from 'lucide-react'
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          {editingCategory === category.id ? (
                            <input
                              ...
                              className="text-lg font-medium text-gray-900 border border-gray-300 rounded px-2 py-1 text-black"
                            ...
                            <div className="flex items-center space-x-3">
                              ...
                              {editingSubcategory?.categoryId === category.id && editingSubcategory?.subcategoryId === subcategory.id ? (
                                <input
                                  ...
                                  className="text-sm text-gray-900 border border-gray-300 rounded px-2 py-1 text-black"
                ...
                <div className="space-y-4">
                  {Object.entries(settings.features).map(([feature, enabled]) => (
                    <div key={feature} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                      ...
                      <button
                        onClick={() => handleFeatureToggle(feature as keyof SystemSettings['features'])}
                  ...
                  <div className="p-4 border border-gray-200 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          type="text"
                          value={settings.platformName || 'Zaillisy'}
                      ...
                      <div>
                        ...
                        <input
                          type="email"
                          value={settings.supportEmail || 'support@goryl.com'}
