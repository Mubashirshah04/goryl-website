...
import { Package, Clock, CheckCircle, XCircle, Truck, Star, Eye, Edit, Save } from 'lucide-react';
  ...
  const handleStatusChange = async (orderId: string, newStatusValue: string) => {
    try {
      ...
      const result = await updateOrderStatus(
        ...
        `Status updated by seller to ${newStatusValue}`,
        'Seller Dashboard'
      );
                ...
                >
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 mb-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      <div>
                        <p className="text-gray-600 dark:text-gray-400">Name: <span className="text-gray-900 dark:text-white">{order.shippingAddress?.firstName} {order.shippingAddress?.lastName}</span></p>
                        <p className="text-gray-600 dark:text-gray-400">Email: <span className="text-gray-900 dark:text-white">{order.userId}</span></p>
                      </div>
                      <div>
                        <p className="text-gray-600 dark:text-gray-400">Address: <span className="text-gray-900 dark:text-white">{order.shippingAddress?.addressLine1}</span></p>
                        <p className="text-gray-600 dark:text-gray-400">City: <span className="text-gray-900 dark:text-white">{order.shippingAddress?.city}, {order.shippingAddress?.state}</span></p>
                      </div>
                    </div>
                  </div>
