...
import { CallOffer } from '@/lib/webrtc';
    ...
    <AnimatePresence>
      <div className="fixed inset-0 bg-black bg-opacity-80 z-[9999] flex items-center justify-center">
        <motion.div
          ...
          className="bg-gradient-to-br from-purple-900 to-blue-900 rounded-3xl p-8 max-w-sm w-full mx-4 shadow-2xl"
        >
          ...
          <div className="relative mb-8 flex justify-center">
            ...
            >
              <img
                src={callData.callerPhoto || `https://api.dicebear.com/7.x/avataaars/svg?seed=${encodeURIComponent(callData.callerName.trim())}`}
              ...
              <motion.div 
                ...
                className="absolute -bottom-2 -right-2 bg-white rounded-full p-3 shadow-2xl ring-4 ring-purple-500/30"
              >
          ...
          <div className="flex items-center justify-center space-x-12">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.85 }}
              onClick={onReject}
              className="bg-red-500 text-white p-5 rounded-full shadow-2xl hover:bg-red-600 transition-colors relative overflow-hidden"
            >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.85 }}
              onClick={onAccept}
              className="bg-green-500 text-white p-5 rounded-full shadow-2xl hover:bg-green-600 transition-colors relative overflow-hidden"
              animate={{
                boxShadow: [
