      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full mx-4 overflow-hidden text-black dark:text-white"
          >
            {/* Close Button */}
            <button
              onClick={onClose}
            ...
            <div className="text-center p-8">
              ...
              <motion.p
                ...
                className="text-black/80 dark:text-gray-400 mb-6"
              >
              ...
              <motion.div
                ...
                className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 mb-6 text-left"
              >
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-black/70 dark:text-gray-400">Order ID:</span>
                  <span className="font-mono text-sm font-medium text-black dark:text-white">
                    #{orderId.slice(-8).toUpperCase()}
                  </span>
                </div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-black/70 dark:text-gray-400">Total Amount:</span>
                  <span className="font-semibold text-green-600 dark:text-green-400">
                    ${orderTotal.toFixed(2)}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-black/70 dark:text-gray-400">Status:</span>
