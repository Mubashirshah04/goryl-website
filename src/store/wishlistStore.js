...
import { getUserWishlist, subscribeToWishlist, addToWishlist as addToWishlistService, removeFromWishlist as removeFromWishlistService } from '@/lib/wishlistService';
import { useAuthStore } from '@/store/authStoreCognito';
// Global tracker to prevent infinite loops
const wishlistFetchTracker = new Set();
export const useWishlistStore = create((set, get) => ({
    ...
    initializeWishlist: async (userId) => {
        ...
        try {
            ...
            if ((error === null || error === void 0 ? void 0 : error.code) === 'permission-denied' || ((error === null || error === void 0 ? void 0 : error.message) && error.message.includes('Permission denied'))) {
                set({
...
export const cleanupWishlistSubscription = () => {
    if (window.wishlistUnsubscribe) {
        ...
        window.wishlistUnsubscribe = null;
    }
};
